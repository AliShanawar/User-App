...
import 'package:Amaaiz/data/repository/auth_repo.dart';
import 'package:Amaaiz/data/repository/banner_repo.dart';
import 'package:Amaaiz/data/repository/brand_repo.dart';
import 'package:Amaaiz/data/repository/cart_repo.dart';
import 'package:Amaaiz/data/repository/category_repo.dart';
import 'package:Amaaiz/data/repository/chat_repo.dart';
import 'package:Amaaiz/data/repository/coupon_repo.dart';
import 'package:Amaaiz/data/repository/flash_deal_repo.dart';
import 'package:Amaaiz/data/repository/notification_repo.dart';
import 'package:Amaaiz/data/repository/onboarding_repo.dart';
import 'package:Amaaiz/data/repository/product_details_repo.dart';
import 'package:Amaaiz/data/repository/order_repo.dart';
import 'package:Amaaiz/data/repository/product_repo.dart';
import 'package:Amaaiz/data/repository/profile_repo.dart';
import 'package:Amaaiz/data/repository/search_repo.dart';
import 'package:Amaaiz/data/repository/seller_repo.dart';
import 'package:Amaaiz/data/repository/splash_repo.dart';
import 'package:Amaaiz/data/repository/support_ticket_repo.dart';
import 'package:Amaaiz/data/repository/wishlist_repo.dart';
import 'package:Amaaiz/helper/network_info.dart';
import 'package:Amaaiz/provider/auth_provider.dart';
import 'package:Amaaiz/provider/banner_provider.dart';
...
import 'package:Amaaiz/provider/product_details_provider.dart';
import 'package:Amaaiz/provider/order_provider.dart';
import 'package:Amaaiz/provider/product_provider.dart';
