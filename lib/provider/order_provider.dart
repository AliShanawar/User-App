...
import 'package:Amaaiz/data/model/response/base/error_response.dart';
...
import 'package:Amaaiz/data/model/response/shipping_method_model.dart';
import 'package:Amaaiz/data/repository/order_repo.dart';
import 'package:Amaaiz/helper/api_checker.dart';
...
class OrderProvider with ChangeNotifier {
  ...
  Future<void> placeOrder(OrderPlaceModel orderPlaceModel, Function callback,
    ...
    notifyListeners();
    ApiResponse apiResponse =
        await orderRepo.placeOrder(orderPlaceModel.toJson());
    _isLoading = false;
    if (apiResponse.response != null &&
        apiResponse.response.statusCode == 200) {
      _addressIndex = null;
