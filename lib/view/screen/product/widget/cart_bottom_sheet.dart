...
import 'package:Amaaiz/view/screen/checkout/checkout_screen.dart';
        ...
        Container(
          ...
          child: Consumer<ProductDetailsProvider>(
            builder: (context, details, child) {
              bool _existInCart = Provider.of<CartProvider>(context)
                  .isAddedInCart(
                      product.id,
                          ...
                          _stock < 1
                              ...
                              : isBuy
                                  ...
                                  : _existInCart
                                      ...
                                      : 'add_to_cart',
                          context),
                      onTap: (_stock < 1 || _existInCart)
                          ? null
                          : () {
                              if (_stock > 0 && !_existInCart) {
