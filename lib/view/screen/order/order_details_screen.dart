...
import 'package:Amaaiz/data/model/response/order_details.dart';
import 'package:Amaaiz/data/model/response/order_model.dart';
...
import 'package:Amaaiz/view/basewidget/button/custom_button.dart';
import 'package:Amaaiz/view/basewidget/custom_app_bar.dart';
import 'package:Amaaiz/view/basewidget/custom_loader.dart';
import 'package:Amaaiz/view/basewidget/show_custom_snakbar.dart';
import 'package:Amaaiz/view/basewidget/title_row.dart';
import 'package:Amaaiz/view/screen/order/widget/order_details_widget.dart';
...
import 'package:Amaaiz/view/screen/tracking/tracking_screen.dart';
                ...
                if (order.orderDetails != null) {
                  ...
                  if (order.shippingList != null) {
                    order.shippingList.forEach((shipping) {
                      if (shipping.id ==
                          order.orderDetails[0].shippingMethodId) {
