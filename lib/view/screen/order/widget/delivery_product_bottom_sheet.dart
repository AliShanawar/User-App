...
class DeliveryProductBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      ...
      Text(getTranslated('products_in_the_cart', context),
          style: robotoRegular),
      ListView.builder(
        ...
        itemBuilder: (context, index) {
          return Column(
            children: [
              Container(
                decoration:
                    BoxDecoration(color: ColorResources.LOW_GREEN, boxShadow: [
                  BoxShadow(
                  ...
                  children: [
                    Row(
                        ...
                        children: [
                          ...
                          Text(getTranslated('REGULAR_COURIER', context),
                    ...
                    Row(
                        ...
                        children: [
                          Text(getTranslated('SELLER', context),
                              textAlign: TextAlign.start,
                              style: titilliumRegular),
                          Text(getTranslated('GADGET_DAILY_OFFICIAL', context),
                              textAlign: TextAlign.end,
                              style: titilliumSemiBold.copyWith(
                                fontSize: Dimensions.FONT_SIZE_LARGE,
                                color: Theme.of(context).primaryColor,
              ...
              ListView.builder(
                ...
                itemBuilder: (context, i) => OrderProductWidget(
