      ...
      child: Row(children: [
        !fromCheckout
            ? InkWell(
                ...
                child: Container(
                  ...
                  child:
                      Provider.of<CartProvider>(context).isSelectedList[index]
                          ? Icon(Icons.done,
        ...
        Padding(
          ...
          child: FadeInImage.assetNetwork(
            ...
            width: 50,
            image:
                '${Provider.of<SplashProvider>(context, listen: false).baseUrls.productThumbnailUrl}/${cartModel.image}',
                  ...
                  children: [
                    Text(
                      PriceConverter.convertPrice(
                          context, cartModel.discountedPrice),
