import 'package:Amaaiz/data/model/response/language_model.dart';

class AppConstants {
  static const String APP_NAME = 'Amaaiz Family Mart';

  static const String BASE_URL = 'https://amaaizfamilymart.com/';
